package com.example.around2.remote.model

data class FeaturedPlacesResponseDto(
    val meta: Meta,
...
data class Attributes(
    ...
    val reyhoon_promotion_amount: ReyhoonPromotionAmount,
    val reyhoon_url: ReyhoonUrl
)
...
data class ReyhoonPromotionAmount(
    val type: String,
    val value: Any
)
